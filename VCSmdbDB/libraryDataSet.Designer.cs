...
namespace VCSmdbDB.libraryDataSetTableAdapters {
    ...
    public partial class booksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `books` (`id`, `title`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `books` SET `id` = ?, `title` = ? WHERE ((`id` = ?) AND ((? = 1 AND `title" +
                "` IS NULL) OR (`title` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::VCSmdbDB.Properties.Settings.Default.libraryConnectionString;
        }
        ...
        public virtual int Delete(global::System.Nullable<int> Original_id, string Original_title) {
        ...
        public virtual int Insert(global::System.Nullable<int> id, string title) {
            if ((id.HasValue == true)) {
        ...
        public virtual int Update(global::System.Nullable<int> id, string title, global::System.Nullable<int> Original_id, string Original_title) {
            if ((id.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string title, global::System.Nullable<int> Original_id, string Original_title) {
